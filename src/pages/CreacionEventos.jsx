...
export function CreacionEventos() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://yeray.informaticamajada.es/api/events', formDataToSend, {
    ...
    return (
        <div className={`form-container ${formTouched ? 'form-touched' : ''}`}>
            <div className="form-content">
                <h2 className="form-title">Crear Nuevo Evento</h2>
                <form onSubmit={handleSubmit} className="association-form" noValidate>
                    ...
                    <div className="form-group">
                        <label htmlFor="imageFile" className="form-label">Imagen (Obligatoria):</label>
...
export default CreacionEventos;