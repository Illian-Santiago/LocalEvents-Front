            ...
            <div className="evento">
                <NavLink to={`/EventoInfo/${id}`}>
                    <div className="evento-header">
                        <img src={`https://yeray.informaticamajada.es/${imagen}`} alt="Asociación" className="asociacion-img" />
                        <span className="asociacion-nombre">{nombre}</span>
                    </div>
                </NavLink>
                <img src={`https://yeray.informaticamajada.es/${imagen}`} alt="Evento" className="evento-img" />
